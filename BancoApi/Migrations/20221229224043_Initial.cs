        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    FaturaDoMes = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    FaturaTotal = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    Limite = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    ContaId = table.Column<int>(type: "int", nullable: true),
                    Ativo = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    DataDeVencimento = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
